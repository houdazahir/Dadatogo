<%@ Page Title="" Language="C#" MasterPageFile="~/menu.Master" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="Dadatogo.Bienv" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-6" ">
                                    <asp:TextBox ID="txt1" runat="server" class="form-control bg-light" placeholder="Nom et prenom"></asp:TextBox>                                    
                                 </div>
                                <div class="col-lg-6">
                                    <asp:TextBox ID="txt2" runat="server" class="form-control bg-light" placeholder="Email" ></asp:TextBox> 
                                </div> 
                            </div>
                             
                            <div class="row">
                                <div class="col-lg-12 py-3">
                                    <textarea id="TextArea1" class="form-control bg-light" placeholder="Votre message" id="" cols="10" rows="6"></textarea>
                                </div>
                            </div>
                            <div class="d-grid gap-2 d-md-block">
                                
                                <asp:Button runat="server"  class="btn btn-primary" type="button" style="background-color: green; border-color: white; width: 80px;" Text="Envoyer" ID="Button1" OnClick="Button1_Click"/>
